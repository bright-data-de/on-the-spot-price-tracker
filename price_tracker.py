...
Info  : https://brightdata.de/products/insights/price-tracker/on-the-spot
"""
...
# https://brightdata.de/products/web-scraper/on-the-spot
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your On the Spot scraper at: https://brightdata.de/products/web-scraper/on-the-spot\n"
